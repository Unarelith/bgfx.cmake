...
if(BGFX_BUILD_EXAMPLES)
	...
	if (EMSCRIPTEN AND BGFX_CONFIG_RENDERER_WEBGPU AND TARGET example-22-windows)
		set(SHELL_FILE ${BGFX_DIR}/examples/22-windows/shell_minimal.html)
		target_link_options(example-22-windows PUBLIC --shell-file ${SHELL_FILE})
		target_sources(example-22-windows PUBLIC ${SHELL_FILE})
	endif()
endif()
